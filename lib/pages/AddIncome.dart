...
class _AddincomeState extends State<Addincome> {
  ...
  late final List ButtonsIncome = [
    CalButton(text: "1",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('1')),
    CalButton(text: "2",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('2')),
    CalButton(text: "3",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('3')),
    CalButton(text: "4",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('4')),
    CalButton(text: "5",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('5')),
    CalButton(text: "6",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('6')),
    CalButton(text: "7",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('7')),
    CalButton(text: "8",buttonColor: Colors.greenAccent, onPressed: () => handleNumberPressIncome('8')),
    ...
    return Scaffold(
      body: Container(
        child: Column(
          ...
          children: [
             AppBar(
            title: Text("Add Income", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.greenAccent),),
      centerTitle: true,
      leading: BackButton(
